#line 1 "C:\\Users\\LENOVO\\OneDrive\\Documents\\C\\_VScode\\0101.cpp"
#include <bits/stdc++.h>
using namespace std;
...
void dfs2(vector<int> adj[], int s, bool visited[])
{
    visited[s] = true;
    cout << s << " ";
    for (int u : adj[s])
